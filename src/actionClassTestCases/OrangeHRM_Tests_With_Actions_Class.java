...
public class OrangeHRM_Tests_With_Actions_Class {
	...
	public static void main(String[] args) throws Exception {
		...
		Thread.sleep(500);
		// can do above actions in one line 
		//act.moveToElement(admin).moveToElement(userManagement).moveToElement(users).build().perform(); 
